...
function convertRadix(value, sourceAlpha, destAlpha, leftPad) {
  let b = bigint_set_str(value, sourceAlpha, sourceAlpha.length)
  let c = bigint_get_str(destAlpha, b)
  if (leftPad) {
    c = strUtils.padLeft(destAlpha[0], value.length, c)
  }
  return c
}
