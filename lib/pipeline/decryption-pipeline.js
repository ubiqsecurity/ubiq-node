...
const { DecodeInputOperation } = require('./operation/decode-input-operation');
const { UnpadInputOperation } = require('./operation/unpad-input-operation');
const { DecryptOperation } = require('./operation/decrypt-operation');
const { ConvertRadixOperation } = require('./operation/convert-radix-operation');
const { DecodeKeyNumberOperation } = require('./operation/decode-key-number-operation');
...
class DecryptionPipeline extends StructuredPipeline {
  ...
  constructor(operationsOrDataset) {
    ...
    if (operationsOrDataset === undefined) {
      this.operations = DecryptionPipeline.baseOperations;
      return;
    }
...
module.exports = { DecryptionPipeline }